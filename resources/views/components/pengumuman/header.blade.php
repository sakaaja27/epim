<header class="fixed-top" id="header">
    <nav class="navbar navbar-expand-xl navbar-light fixed-top bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img src="{{ asset('img') }}/LogoEPIM.png" alt="logo"
                    width="120"></a>
                ...
                <ul class="navbar-nav ml-auto justify-content-end flex-grow-1">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="/pengumuman-kategori-poster" class="dropdown-item">Design Poster</a>
                            <a href="/pengumuman-kategori-video" class="dropdown-item">Videography</a>
                        </div>
                    </li>
                    <li class="nav-item">
                    ...
                    @if (!Auth::check())
                        ...
                        <li class="nav-item">
                            <a class="nav-link scrollto" href="{{ route('Dashboard_peserta') }}">Dashboard</a>
                        </li>
                        <li class="nav-item">
